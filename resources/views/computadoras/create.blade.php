...
@php
    $usuariosSeleccionados = collect(old('id_usuarios_asignados', []))
        ->map(fn($id) => (int) $id)
        ->toArray();
@endphp
...
<div class="contenedor-form">
    ...
    <div class="encabezado-form">
        ...
        <p>Registra un nuevo equipo con su información técnica, estado, ubicación y usuarios asignados.</p>
    </div>
    ...
    <div class="cuerpo-form">
        ...
        <form action="{{ route('computadoras.store') }}" method="POST" enctype="multipart/form-data" id="formComputadora">
            @csrf
            ...
            <div class="grid">
                ...
                <div class="campo">
                    ...
                    @error('nombre_equipo')
                        <small style="color:#dc2626; margin-top:6px; font-size:12px;">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="campo">
                    ...
                    >
                    @error('fecha_compra')
                        <small style="color:#dc2626; margin-top:6px; font-size:12px; display:block;">
                            {{ $message }}
                        </small>
                    @enderror
                </div>
