...
<button class="btn-volver" onclick="cerrarModal()">
Volver
</button>

<button class="btn-primary" onclick="confirmarSeleccion()">
Confirmar
</button>
...
let seleccionado =
document.querySelector('input[name="equipoSeleccionado"]:checked');
...
document.getElementById("computadoraSeleccionada").value =
seleccionado.value;

document.getElementById("nombreComputadora").value =
...
let input =
document.getElementById("buscarEquipo").value.toLowerCase();
